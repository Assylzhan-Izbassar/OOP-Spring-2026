...
public class EnrollmentService {
	...
	public void assignGrade(Student s, Course c, double grade) {
		for (Enrollment e: this.enrollments) {
			if (e.getS().equals(s) && e.getC().equals(c)) {
				e.addMark(grade);
			}
		}
	}
	
	public void markAttendance(Student s, Course c, LocalDate date) {
		for (Enrollment e: this.enrollments) {
			if (e.getS().equals(s) && e.getC().equals(c)) {
...
//				a.attend();
	...
	public void showAttendance(Student s, Course c) {
		System.err.println("Attendances:");
		for (Enrollment e: this.enrollments) {
			if (e.getS().equals(s) && e.getC().equals(c)) {
	...
	public void printCourse(Student s) {
		...
		for (Enrollment e: this.enrollments) {
			if (e.getS().equals(s)) {
				System.out.println(e.getC() + " " + e.getFinalGrade());
			}
		}
	}
}
